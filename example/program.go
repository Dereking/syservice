...
func NewProgram(userService_ syservice.ISerivce) *Program {
	return &Program{
		userService: userService_,
	}
}

func (p *Program) Start(s *syservice.Syservice) error {
...
func (p *Program) Stop(s *syservice.Syservice) error {
	return nil
}
